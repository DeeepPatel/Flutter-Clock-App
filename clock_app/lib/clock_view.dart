...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double i = 0; i < 360; i += 6) {
      // var x1 = centerX + (outerCircleRadius - 55) * cos(i * pi / 180);
      // var y1 = centerX + (outerCircleRadius - 55) * sin(i * pi / 180);

      // var x2 = centerX + (innerCircleRadius - 50) * cos(i * pi / 180);
      // var y2 = centerX + (innerCircleRadius - 50) * sin(i * pi / 180);
      var x1 = centerX + (outerCircleRadius - 5) * cos(i * pi / 180);
      var y1 = centerY + (outerCircleRadius - 5) * sin(i * pi / 180);

      var x2 = centerX + innerCircleRadius * cos(i * pi / 180);
      var y2 = centerY + innerCircleRadius * sin(i * pi / 180);
      canvas.drawLine(Offset(x1, y1), Offset(x2, y2), dashMinBrush);
    }

    for (double i = 0; i < 360; i += 30) {
      // var x1 = centerX + (outerCircleRadius - 50) * cos(i * pi / 180);
      // var y1 = centerX + (outerCircleRadius - 50) * sin(i * pi / 180);
